...
*/
	...
	let body = (`<h1 style="text-align:center; color: #0275d8;">${title}</h1>
		...
		<p>Help us reach more people: <a href="https://twitter.com/greathumanskill?ref_src=twsrc%5Etfw" class="twitter-follow-button" data-show-screen-name="false" data-dnt="true" data-show-count="false">Follow @greathumanskill</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script> on Twitter.</p>
		`);
